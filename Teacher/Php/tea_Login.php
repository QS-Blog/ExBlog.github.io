...
<head>
    ...
    <title>教师登录</title> <!-- 网页的标题 -->
    <link rel="stylesheet" href="..\Css\tea_Login.css"> <!-- 引入CSS文件以应用样式 -->

    <?php session_start(); // 开启session
    $_SESSION['type'] = "teacher"; ?> <!-- 设置session -->
</head>
...
<body>
    ...
    <div class="shell">
        ...
        <div class="container b-container" id="b-container">
            <form action="..\Tool\tea_Login_in.php" method="post" class="form" id="b-form">
                <h2 class="form_title title">登入账号</h2>
                <input type="text" class="form_input" placeholder="职工号" id="teacherId" name="teacherId" required />
...
<script>
    ...
    function validatePasswords() {
        var firstPassword = document.querySelector('input[name="firstPassword"]').value;
        var surePassword = document.querySelector('input[name="surePassword"]').value;
